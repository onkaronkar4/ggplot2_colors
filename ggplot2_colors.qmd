...
![1️⃣](https://abs-0.twimg.com/emoji/v2/svg/31-20e3.svg){alt="1️⃣"} - case_when() or if_else()
![2️⃣](https://abs-0.twimg.com/emoji/v2/svg/32-20e3.svg){alt="2️⃣"} - scale\_\*\_identity()
...
![1️⃣](https://abs-0.twimg.com/emoji/v2/svg/31-20e3.svg){alt="1️⃣"}
